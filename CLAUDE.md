...
Four modules in a strict one-directional pipeline. **`orchestrator.py` is the only stateful/coordinating layer**; the other three are intended to stay independently callable:
